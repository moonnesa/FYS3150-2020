# -*- coding: utf-8 -*-
"""
Created on Wed Nov 25 12:04:01 2020
...
T,E,Cv,X,M,Mabs,Nacc = np.loadtxt("expectations1.dat",usecols=(0,1,2,3,4,5,6), unpack=True)
Ts,Es,Cvs,Xs,Ms,Mabss,Naccs = np.loadtxt("expectations24_2.dat",usecols=(0,1,2,3,4,5,6), unpack=True)
#cycles = len(T)
#time = range(cycles)
